...
# 32 "<command-line>" 2
# 1 "main.c"
# 1 "include/my_logger.h" 1
# 34 "include/my_logger.h"
typedef enum {
    NONE = 0,
    PRINT_RESULT,
    ERROR,
...
# 77 "include/my_logger.h"
void log_message(log_level_t level, const char *fmt, ...);
# 89 "include/my_logger.h"
log_level_t set_log_level(log_level_t new_level);
# 143 "include/my_logger.h"
...
# 22 "main.c"
    ...
    log_message(DEBUG, "SYSTEM LOGGINGS ACTIVATED :) !!! \n\n", "");
    return 0;
}
