...
9. [🔬 -->  Длина арифметического шага для двух указателей](https://github.com/kolesnikovvitaliy/LERNING_C/tree/main/EXTREME_C/Основные_возможноти_языка/Указатели_на_переменные/Арифметические_операции_указателями_на_переменные/Длина_арифметического_шага_для_двух_указателей/)
10. [🔬 -->  Перебор_элементов_массива_без_арифметики_указателей](https://github.com/kolesnikovvitaliy/LERNING_C/tree/main/EXTREME_C/Основные_возможноти_языка/Указатели_на_переменные/Арифметические_операции_указателями_на_переменные/Перебор_элементов_массива_без_арифметики_указателей/)
11. [🔬 -->  Перебор_элементов_массива_с_помощью_арифметики_указателей](https://github.com/kolesnikovvitaliy/LERNING_C/tree/main/EXTREME_C/Основные_возможноти_языка/Указатели_на_переменные/Арифметические_операции_указателями_на_переменные/Перебор_элементов_массива_с_помощью_арифметики_указателей/)
