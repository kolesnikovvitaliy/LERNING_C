...
---
---
[ПРИМЕРЫ ИСПОЛЬЗОВАНИЯ --> ](https://github.com/kolesnikovvitaliy/LERNING_C/tree/main/EXTREME_C/Основные_возможноти_языка/Указатели_на_переменные/Указатели_на_переменные/exemple)
---
